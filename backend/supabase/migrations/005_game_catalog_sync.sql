...
VALUES
    ...
    ('pulonia', 'Pulonia', 'Прюн', 'Hydro', 'Catalyst', 4, 'mondstadt', 'pulonia'),
    ('loen', 'Loen', 'Лоэн', 'Cryo', 'Bow', 5, 'mondstadt', 'loen'),
    ...
    ('flins', 'Flins', 'Флинс', 'Electro', 'Sword', 5, 'nodkrai', 'flins'),
    ('nefer', 'Nefer', 'Нефер', 'Dendro', 'Catalyst', 5, 'nodkrai', 'nefer'),
    ('yagoda', 'Yagoda', 'Ягода', 'Hydro', 'Catalyst', 4, 'nodkrai', 'yagoda'),
    ('columbina', 'Columbina', 'Колумбина', 'Hydro', 'Catalyst', 5, 'nodkrai', 'columbina'),
    ('illuga', 'Illuga', 'Иллуга', 'Geo', 'Claymore', 5, 'nodkrai', 'illuga'),
